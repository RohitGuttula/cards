...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handlecardsAlreadyExistsException(CardsAlreadyExistsException exception,
                                                                              WebRequest request){
    ...
    public ResponseEntity<ErrorResponseDto> handleResourceNotFoundException(ResourceNoFoundException exception,
                                                                            WebRequest request){
        ErrorResponseDto errorResponseDto=new ErrorResponseDto(
                request.getDescription(false),
